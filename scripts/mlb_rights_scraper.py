...
class MLBPostalLookup:
    def __init__(self, output_dir: str = "data", logs_dir: str = "logs"):
        self.output_dir = output_dir
        self.logs_dir = logs_dir
        self.base_url = "https://content.mlb.com/data/blackouts"
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(os.path.join(logs_dir, "mlb_lookup.log")),
    ...
    async def process_zip_code(
        ...
        """Process a single ZIP code through the MLB API."""
    ...
    def save_results(self, df: pd.DataFrame) -> str:
        ...
        filename = f"mlb_market_teams_{timestamp}.csv"
    ...
    def create_summary_report(
        ...
        with open(report_path, "w") as f:
            f.write("MLB Postal Code Lookup Summary Report\n")
            f.write("===================================\n\n")
...
async def main_async():
    parser = argparse.ArgumentParser(
        description="Look up MLB market teams for ZIP codes"
    )
    parser.add_argument(
        "--input-file",
    ...
    processor = MLBPostalLookup(output_dir=args.output_dir, logs_dir=args.logs_dir)
