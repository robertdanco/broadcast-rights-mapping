...
class NHLPostalLookup:
    def __init__(self, output_dir: str = "data", logs_dir: str = "logs"):
        self.output_dir = output_dir
        self.logs_dir = logs_dir
        self.base_url = "https://api-web.nhle.com/v1/postal-lookup"
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(os.path.join(logs_dir, "nhl_lookup.log")),
    ...
    async def process_zip_code(
        ...
        """Process a single ZIP code through the NHL API."""
        ...
        try:
            ...
            async with session.get(url, headers=get_headers()) as response:
                ...
                team_names = [team["teamName"]["default"] for team in data]
                return True, ",".join(sorted(team_names))
    ...
    def save_results(self, df: pd.DataFrame) -> str:
        ...
        filename = f"nhl_market_teams_{timestamp}.csv"
    ...
    def create_summary_report(
        ...
        with open(report_path, "w") as f:
            f.write("NHL Postal Code Lookup Summary Report\n")
            f.write("===================================\n\n")
...
async def main_async():
    parser = argparse.ArgumentParser(
        description="Look up NHL market teams for ZIP codes"
    )
    parser.add_argument(
        "--input-file",
    ...
    processor = NHLPostalLookup(output_dir=args.output_dir, logs_dir=args.logs_dir)
